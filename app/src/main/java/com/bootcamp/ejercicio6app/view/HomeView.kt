...
import com.bootcamp.ejercicio6app.components.AppBodd


import com.bootcamp.ejercicio6app.components.AppButt
...
fun HomeView(viewModel: MovieViewModel) {
    ...
    Scaffold(
        topBar = { AppButt(title = stringResource(R.string.app_name)) },
